...
export const dictionary = {
    ...
    booking: {
      ...
      qty1People: "1–2 hengelle",
      qty2People: "3–4 hengelle",
      qty3People: "5–6 hengelle",
      qtyHelper:
        "Kalustossa on 2 vesijettiä ja yhden päälle mahtuu joko max 180 kg tai max 2 henkilöä.",
      ...
      deliveryOtherTitle: "Haluatko jonkun toisen lähtöpaikan?",
      deliveryOtherBody:
        "Jos haluat että vesijettiseikkailusi lähtee jostain toisesta satamasta tai ylipäätään jostain toisesta paikasta, ole rohkeasti yhteydessä joko puhelimitse tai sähköpostitse!",
      fullName: "Koko nimi",
      ...
      summaryQtyValue: "{n}× vesijetti",
      summaryPickup: "Lähtöpaikka",
      summaryRent: "Vuokra",
  ...
  en: {
    ...
    booking: {
      ...
      qtyHelper:
        "We have 2 jet skis. Each one fits max 180 kg or 2 people.",
      ...
      deliveryOtherTitle: "Want a different departure point?",
      deliveryOtherBody:
        "If you'd like your jet ski adventure to start from another marina or somewhere else entirely, just reach out by phone or email!",
      fullName: "Full name",
      ...
      summaryQty: "Jet skis",
      summaryQtyValue: "{n}× jet ski",
      summaryPickup: "Departure",
      summaryRent: "Rental",
