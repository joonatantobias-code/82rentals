...
export const dictionary = {
    ...
    booking: {
      ...
      validation: {
        ...
        birthdateError: "Anna syntymäaikasi.",
        ageError: "Vesijetin vuokraajan tulee olla vähintään 16-vuotias.",
        companionNameError: "Anna kyytiläisen etu- ja sukunimi.",
        companionBirthdateError: "Anna kyytiläisen syntymäaika.",
      },
      ...
      companionToggleHelper:
        "Kerro kyytiläisen tiedot, niin saamme molemmat valmiiksi vuokraukseen.",
      companionFirstNameLabel: "Kyytiläisen etunimi",
      companionLastNameLabel: "Kyytiläisen sukunimi",
      companionBirthdateLabel: "Kyytiläisen syntymäaika",
  ...
  en: {
    ...
    booking: {
      ...
      validation: {
        ...
        companionBirthdateError: "Please enter the passenger's date of birth.",
      },
