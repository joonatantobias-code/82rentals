...
export const dictionary = {
    ...
    booking: {
      ...
      deliveryNotesHint: "Pakollinen kun valitset toimituksen. Soitamme aina ennen vahvistusta varmistaaksemme paikan ja lisämaksun.",
      fullName: "Koko nimi",
  ...
  en: {
    ...
    booking: {
      ...
      deliveryNotesHint: "Required when you pick delivery. We'll always call before confirming to lock in the spot and the extra fee.",
      fullName: "Full name",
