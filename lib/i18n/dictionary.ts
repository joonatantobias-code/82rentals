...
export const dictionary = {
    ...
    booking: {
      ...
      deliveryNotesHint: "Voit jättää lisätietoja jos haluat. Soitamme joka tapauksessa ennen vahvistusta sopiaksemme tarkasta paikasta ja lisämaksusta.",
  ...
  en: {
    ...
    booking: {
      ...
      deliveryNotesHint: "Optional. We'll call before confirming anyway to agree on the exact spot and the extra fee.",
