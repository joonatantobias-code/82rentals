  ...
  return (
    <>
      <PageHero
        ...
        description="Vastaamme yleensä saman päivän aikana. Soita, laita sähköpostia tai DM:ää somessa."
        crumbs={[{ label: "Yhteystiedot" }]}
      />
      ...
      <section className="section">
        <div className="grid lg:grid-cols-2 gap-5">
          <ContactRow
            ...
            hint="Joka päivä klo 9 alkaen 21 saakka kauden aikana"
          ...
          <ContactRow
            ...
            hint="Vastaamme alle 24 tunnissa"
          ...
          <ContactRow
            ...
            hint="DM toimii myös varauksiin"
          ...
          <ContactRow
            ...
            hint="Päivitykset ja kaluston esittelyt"
            color="bg-brand-secondary"
            iconClass="text-white"
          />
        </div>
        ...
        <div className="mt-10 grid md:grid-cols-2 gap-5">
          <div className="rounded-2xl bg-brand-secondary text-white p-6 sm:p-7 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-white/80 text-sm mt-2 leading-relaxed">
                Toimimme koko Helsingin rannikkoalueella. Kerro varauksessa
                haluamasi paikka, saavumme paikalle.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-brand-primary-50 border border-brand-primary/30 p-6 sm:p-7">
            ...
            <p className="text-brand-secondary/70 text-sm mt-2 leading-relaxed">
              Ajokausi alkaa kun jää lähtee ja kestää syksyyn. Alkukauden ja
              loppukauden varauksiin voi soveltua erityisehtoja, varmista
              meiltä.
            </p>
          </div>
        </div>
